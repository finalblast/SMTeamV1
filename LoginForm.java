...
//       AddIconFrame();
    ...
    JLabel ImageLogo;
    private void AddIconFrame() {
//       lbel=new JLabel(new ImageIcon("Images/login.jpg")); 
//       lbel.setPreferredSize(new Dimension(300,300));
//       add(lbel);
        
        ImageLogo.setIcon( new ImageIcon(getClass().getResource("/Images/logo.jpg")));
        add(ImageLogo);
    }
}
